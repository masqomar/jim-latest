...
@section('title', 'Rekapitulasi Simpanan Anggota')
@section('content')
            ...
            <div class="col-md-12">
                <div class="card ">
                    <div class="card-header bg-navy">
                        <h3 class="card-title"><b style="font-size: 30px" class="mr-1">L</b>APORAN TRANSAKSI SIMPANAN </h3><br>
                        <hr class="mt-3 mb-0" style="border: 1px solid #fff">
                    </div>
                    <div class="card-header">
                        <div class="row">
                            <form action="{{route('user-saving-transactions.index')}}" method="get">
                                @php
                                $configYear = ['format' => 'Y'];
                                @endphp
